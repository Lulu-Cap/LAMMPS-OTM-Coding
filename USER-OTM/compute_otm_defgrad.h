...
ComputeStyle(otm/defgrad,ComputeOTMDefgrad)

#else

#ifndef LMP_COMPUTE_OTM_DEFGRAD_H
#define LMP_COMPUTE_OTM_DEFGRAD_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeOTMDefgrad : public Compute {
 public:
  ComputeOTMDefgrad(class LAMMPS *, int, char **);
  ~ComputeOTMDefgrad();
  void init();
